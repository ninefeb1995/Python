"""
Django settings for airmeasuring project.
...
SECRET_KEY = '#+b#8v8^o&57#wj&2oh45q6jr4guw78vp&yr=1syttozo(s$un'
...
MIDDLEWARE = [
    ...
    'django.contrib.custom_auth.middleware.AuthenticationMiddleware',
