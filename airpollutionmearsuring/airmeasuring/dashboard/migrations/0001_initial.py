# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-09-01 08:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measuring_date', models.DateField(default=datetime.date(2017, 9, 1))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dashboard.Node')),
            ],
        ),
    ]
